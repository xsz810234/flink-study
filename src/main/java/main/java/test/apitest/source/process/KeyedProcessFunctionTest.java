...
public class KeyedProcessFunctionTest {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<UrlCountPOJO> aggregate = singleOutputStreamOperator.keyBy(data -> data.getUrl())
                ...
                }, new ProcessWindowFunction<Long, UrlCountPOJO, String, TimeWindow>() {
                    @Override
                    public void process(String s, Context context, Iterable<Long> elements, Collector<UrlCountPOJO> out) throws Exception {
